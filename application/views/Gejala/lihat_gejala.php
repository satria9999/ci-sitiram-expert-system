...
<div class="sl-pagebody">
    ...
    <a href="<?php echo base_url('Dashboard/form_gejala');?>"
                ...
                <tbody>
                    ...
                    foreach ($gejala as $key) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('Gejala/edit_data/'. $key->kode_gejala); ?>"
                                
                                   class="btn btn-warning btn-circle btn-sm">
                                   <ion-icon name="create-outline" style="font-size: 1rem; margin-right: 5px;"></ion-icon>edit
                                </a>
                                <a href="<?php echo site_url('Gejala/delete/'. $key->kode_gejala); ?>"
