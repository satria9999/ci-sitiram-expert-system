...
<html lang="en">
  ...
  <body>
    ...
    <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-30 bg-white">
      <div class="logo-container tx-center ">
                <img src="<?= base_url(); ?>assets/img/sitiram.jpg" alt="Logo" width="170">
            </div>
        <div class="signin-logo tx-center tx-22 tx-bold tx-inverse">BP3K Karawang <span class="tx-info tx-normal"></span></div>
        <div class="tx-center mg-b-10">Aplikasi Mendiagnosa Penyakit & Hama Jamur Tiram</div>
        ...
        <div class="mg-t-60 tx-center">Not yet a member? <a href="<?php echo base_url('auth/form_register');?>" class="tx-info">Sign Up</a></div>
      </div><!-- login-wrapper -->
    </div><!-- d-flex -->
