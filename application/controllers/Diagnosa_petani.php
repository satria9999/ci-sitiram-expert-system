...
class Diagnosa_petani extends CI_Controller {
...
public function Perhitungan_Petani()
{
...
public function export_pdf_diagnosa_petani($id_diagnosa)
	{
	...
	$this->mypdfgenerator->generate('petani/Diagnosa/print_diagnosa',$data);
	}
}